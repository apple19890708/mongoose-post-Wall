...
// const Post = require('./models/post'); // 載入Room Model
...
const postsListener = require('./routes/posts')

// connections/index.js
require('./connections');

const serve = async (req, res) => {
	// roomsListener(req, res);
	postsListener(req, res);
};
